# 🔥 👊 👤 Comprehensive Public Datasets for AI Model Training
...
1. [🔥 Fire & Smoke Detection Datasets](#-fire--smoke-detection-datasets)
2. [👊 Fight/Violence Detection Datasets](#-fightviolence-detection-datasets)
3. [👤 Face Detection & Recognition Datasets](#-face-detection--recognition-datasets)
4. [📥 Download Instructions](#-download-instructions)
5. [🔧 Dataset Preparation](#-dataset-preparation)
6. [🚀 Training Recommendations](#-training-recommendations)
...
## 🚬 Smoke-Only Detection Datasets (For Early Fire Warning)
...
## 🚭 Cigarette/Smoking Detection Datasets (Critical for Petrol Pumps)
...
## 👤 Face Detection & Recognition Datasets
...
| 4 | **FFHQ (Flickr-Faces-HQ)** | 70,000 | High-quality faces | 1024×1024 PNG | [GitHub: NVlabs/ffhq-dataset](https://github.com/NVlabs/ffhq-dataset) |
...
│   ├── valid/
│   └── test/
└── combined/        # Merged all categories
    ├── train/
    ├── valid/
    └── test/
```
...
#### 🔥 Fire & Smoke (Target: 15,000+ images)
...
#### 👊 Fight/Violence (Target: 20,000+ images)
...
#### 👤 Face Detection (Target: 30,000+ images)
...
#### 👤 Face Recognition (Target: 100+ identities, 500+ per identity)
...
|-----------------|-----------------|----------------|
| Roboflow Public | CC-BY-4.0 / MIT | ✅ Usually allowed |
| Kaggle Datasets | Varies | ⚠️ Check each dataset |
| Academic (VGGFace2, etc.) | Research only | ❌ Request permission |
| WIDER FACE | Research only | ❌ Academic use only |
